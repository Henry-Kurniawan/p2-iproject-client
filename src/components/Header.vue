          ...
          <div class="col-3">
            ...
            <!-- <div class="input-group">
              ...
              >
                <button 
                v-if="isLoggedIn"
                type="button" class="btn btn-labeled btn-warning">
          ...
          <div class="col-3">
            ...
            >
              <div class="row">
                ...
                <div class="col-8">
                  <h6>emaillllllllllllllllllllllllaaaaaaaaaaaaaaaaaaaaaaaaa</h6>
                  <button @click.prevent="logoutHandler" type="button" class="btn btn-primary btn-sm">
                    <span
